...
export const Header = () => {
  ...
  const inActiveClass =
    "text-base block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700";
        ...
        <div className="xl:container flex flex-wrap justify-between items-center mx-auto">
          ...
          >
            ...
            <ul
              className={`${
                hidden ? "hidden" : ""
              } lg:flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 lg:flex-row lg:space-x-8 lg:mt-0 lg:text-sm lg:font-medium lg:border-0 lg:bg-white dark:bg-gray-800 lg:dark:bg-gray-900 dark:border-gray-700`}
            >
              <li>
                <NavLink
                  to="/"
